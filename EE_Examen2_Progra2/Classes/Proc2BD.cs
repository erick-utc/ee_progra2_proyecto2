...
namespace EE_Examen2_Progra2.Classes
{
    public class Proc2BD
    {
        ...
        public static int reporteUsuarioPorCorreo(string correo, GridView dg)
        {
            int ret = 0;
            ...
            try
            {
                using (cnx = Connexion.getConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("REPORTE_USUARIO_CORREO", cnx)
                    {
                        CommandType = CommandType.StoredProcedure
                    })
                    {
        ...
        public static int reporteUsuarioPorNombre(string nombre, GridView dg)
        {
            int ret = 0;
            ...
            try
            {
                using (cnx = Connexion.getConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("REPORTE_USUARIO_NOMBRE", cnx)
                    {
                        CommandType = CommandType.StoredProcedure
                    })
                    {
        ...
        public static int validarLogin(string Username,  string Password)
        {
            ...
            try
            {
                using (cnx = Connexion.getConnection())
                {
                    SqlCommand cmd = new SqlCommand("VALIDAR_LOGIN", cnx)
                    {
                        CommandType = CommandType.StoredProcedure
                    };
        ...
        public static int reporteAdmin( GridView dg)
        {
            int ret = 0;
            ...
            try
            {
                using (cnx = Connexion.getConnection())
                {
                    using (SqlCommand cmd = new SqlCommand("REPORTE_ADMIN", cnx)
                    {
                        CommandType = CommandType.StoredProcedure
                    })
                    {
