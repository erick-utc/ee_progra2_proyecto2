...
CREATE TABLE AuthUsers(
	...
	RoleID Int,
	CONSTRAINT fk_authUsers_roleId FOREIGN KEY (RoleID) REFERENCES Roles(RoleID)
)
GO
...
CREATE PROCEDURE REPORTE_USUARIO_CORREO
@CORREO VARCHAR(50)
AS 
	BEGIN
...
CREATE PROCEDURE REPORTE_USUARIO_NOMBRE
@NOMBRE VARCHAR(50)
AS 
	BEGIN
		SELECT Usuarios.Nombre, Usuarios.CorreoElectronico, Equipos.Modelo, Equipos.TipoEquipo, Reparaciones.Estado, Asignaciones.FechaAsignacion, Tecnicos.Nombre, DetallesReparacion.Descripcion
